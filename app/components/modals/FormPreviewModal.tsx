...
export default function FormPreviewModal({
  ...
  const inputBase =
    "w-full bg-white border border-slate-300 rounded-md p-2.5 text-sm outline-none focus:border-slate-900 focus:ring-1 focus:ring-slate-900 transition-all";
          ...
          {activeFields.length > 0 ? (
              ...
              <div key={index} className="max-w-xl mx-auto">
                ...
                {field.type === "textarea" && (
                  <textarea
                    rows={4}
                    className={inputBase}
                    placeholder="Saisir votre réponse détaillée..."
                  />
                )}
            ...
            <div className="text-center py-20">
              ...
              <p className="text-slate-500 text-sm">
                Aucun champ configuré pour le moment.
              </p>
            </div>
          )}
        </div>
